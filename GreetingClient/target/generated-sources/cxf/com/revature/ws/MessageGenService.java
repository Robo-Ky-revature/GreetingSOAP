 ...
 * 2016-08-23T10:41:36.383-04:00
 * Generated source version: 3.1.6
 * 
 */
@WebServiceClient(name = "messageGenService", 
                  wsdlLocation = "http://localhost:9001/SOAPGreeting/greetingservice?wsdl",
...
public class MessageGenService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:9001/SOAPGreeting/greetingservice?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MessageGenService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:9001/SOAPGreeting/greetingservice?wsdl");
        }
        WSDL_LOCATION = url;
    }
